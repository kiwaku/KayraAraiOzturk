...
class Slider {
  constructor() {
    ...
    'https://awswebbucket1926.s3.ap-northeast-1.amazonaws.com/bg2.png',
    'https://awswebbucket1926.s3.ap-northeast-1.amazonaws.com/bg3.png',
  ];
...
window.onload = function() {
  grained('#wrapper', grainAnimation);
  setTimeout(function() {
